...
# 用于推荐（热门短评）配置
MAX_REVIEWS_PER_MOVIE = 60   # 每部电影最多抓多少条（20 的倍数）
...
def scrape_douban_data():
    ...
    try:
        ...
        max_attempts = 15 # 最大尝试点击次数，避免无限循环
        attempt = 0
...
if __name__ == '__main__' :
    ...
    if movie_list and review_list :
        ...
        movies_csv_filename = data_dir / "movies.csv"
        ...
        reviews_csv_filename = data_dir / "reviews_douban.csv"
